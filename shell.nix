...
pkgs.mkShell rec {
  ...
  buildInputs = with pkgs; [
    ...
    fontconfig # for depth map generation plugin
  ...
  shellHook = ''
    ...
    echo "Stable Diffusion WebUI for Nix"
    echo "=============================="
    echo ""
    echo "Download Stable Diffusion WebUI:"
    echo "  git clone https://github.com/AUTOMATIC1111/stable-diffusion-webui.git"
    echo ""
    echo "Update Stable Diffusion WebUI:"
    ...
    echo ""
    echo "Enter Stable Diffusion Webui Python VEnv and installing extra packages:"
    echo "  cd stable-diffusion-webui/"
